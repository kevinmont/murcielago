...
<YYINITIAL> "m"				{ save(new Data("M: Tipo de acceso",yytext(),"Palabra reservada ",1));								 	return symbol(sym.M, new Integer(0)); }
<YYINITIAL> "u"				{ save(new Data("U: Tipo de acceso",yytext(),"Palabra reservada ",1));									return symbol(sym.U, new Integer(1)); }
<YYINITIAL> "r"				{ save(new Data("R: Tipo de acceso",yytext(),"Palabra reservada ",1));									return symbol(sym.R, new Integer(2)); }
<YYINITIAL> "c"				{ save(new Data("C: Tipo de acceso",yytext(),"Palabra reservada ",1));									return symbol(sym.C, new Integer(3)); }
<YYINITIAL> "i"				{ save(new Data("I: Tipo de acceso",yytext(),"Palabra reservada ",1));									return symbol(sym.I, new Integer(4)); }
<YYINITIAL> "e"				{ save(new Data("E: Tipo de acceso",yytext(),"Palabra reservada ",1));									return symbol(sym.E, new Integer(5)); }
<YYINITIAL> "l"				{ save(new Data("L: Tipo de acceso",yytext(),"Palabra reservada ",1));									return symbol(sym.L, new Integer(6)); }
